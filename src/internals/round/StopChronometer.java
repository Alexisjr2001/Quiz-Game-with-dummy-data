...
public class StopChronometer extends Round{
    ...
    public String getRoundDescription() {
        return String.format("Υπάρχει ένα χρονόμετρο που μετράει αντίστροφα 5 δευτερόλεπτα!%n" +
     ...
     * @param actionListener Χρησιμοποιείται για την επικοινωνία με την γραφική διεπαφή χρήστη, προστίθεται ως ActionListener του χρονόμετρου και ενεργοποιείται κάθε 100ms.
     */
    ...
    /**
     * Επιστρέφει τα δευτερόλεπτα που απομένουν όταν καλείται η μέθοδος.
     * @return Τα milliseconds που απέμεναν.
     */
    public int getTime(){
        return count;
    }
     ...
     * και των milliseconds που απέμεναν ακόμα, όταν απάντησε ο παίχτης.
