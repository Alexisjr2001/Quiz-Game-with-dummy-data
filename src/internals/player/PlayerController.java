...
public class PlayerController {
     ...
     * @return κατάσταση επιτυχίας. "Επιτυχία" σε περίπτωση επιτυχίας, διαφορετικά επιστρέφει "Δεν υπάρχει παίχτης με το όνομα: " + playerName + " ! Δεν μπορεί να γίνει αλλαγή όνομα παίχτη που δεν υπάρχει..." ή  "Υπάρχει ήδη παίχτης με αυτό το όνομα" αντιστοίχως με το πρόβλημα.
     */
