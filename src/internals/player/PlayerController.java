...
public class PlayerController {
    ...
    /**
     * Επιστρέφει δισδιάστατο πίνακα συμβολοσειρών που αναπαριστούν τον πίνακα με τα δεδομένα όλων των αποθηκευμένων παιχτών.
     *
     ...
     * η δεύτερη στήλη ({@code getScoreboard()[i][1]}) το τρέχον σκορ του (i-ου) παίχτη (στο ατομικό παιχνίδι),
    ...
    /**
     * Επιστρέφει το τρέχον σκορ (στο ατομικό παιχνίδι) του παίχτη (αν αυτός υπάρχει) με το όνομα που δίνεται ως όρισμα.
     ...
     * @return το σκορ του παίχτη (στο ατομικό παιχνίδι) αν αυτός υπάρχει, διαφορετικά -1.
     */
    ...
    /**
     * Υπολογίζει και αποθηκεύει το νέο σκορ (στο ατομικό παιχνίδι) του παίχτη (αν αυτός υπάρχει) του οποίου το όνομα δίνεται ως όρισμα και επιστρέφεται η κατάσταση επιτυχίας αυτής της ενέργειας.
     * Αν υπάρχει παίχτης με αυτό το όνομα, η ενέργεια επιτυγχάνει και επιστρέφεται true, διαφορετικά επιστρέφεται false.
     * Άν το νέο σκορ είναι μεγαλύτερο απο το παλιό, το νέο τίθεται ως το μέγιστο σκορ παίχτη (στο ατομικό παιχνίδι).
     *
     * @param playerName όνομα του παίχτη.
     * @param gain πόντοι που θα προστεθούν στο τρέχον σύνολο πόντων στο ατομικό παιχνίδι (μπορεί να είναι και αρνητικό).
    ...
    /**
     * Επιστρέφει το μέγιστο σκορ (στο ατομικό παιχνίδι) (highScore) του παίχτη (αν αυτός υπάρχει) του οποίου το όνομα δίνεται ως όρισμα.
     ...
     *
     * @param playerName όνομα του παίχτη.
     * @return το μέγιστο (στο ατομικό παιχνίδι) σκορ (highScore) του παίχτη αν αυτός υπάρχει, διαφορετικά -1.
     */
    ...
    /**
     * Μηδενίζει το τρέχον σκορ (στο ατομικό παιχνίδι) του παίχτη του οποίου το όνομα δίνεται ως όρισμα.
     * @param playerName όνομα του παίχτη.
     * @return η κατάσταση επιτυχίας της μεθόδου. "Επιτυχία" σε περίπτωση επιτυχίας, "Δεν υπάρχει παίχτης με το συγκεκριμένο όνομα" διαφορετικά.
     */
    ...
    /**
     * Μηδενίζει το τρέχον σκορ (στο ατομικό παιχνίδι) κάθε παίχτη
     */
    ...
    /**
     * Φορτώνει στην μνήμη τα στατιστικά των παιχτών, δηλαδή όνομα,High Score (στο ατομικό παιχνίδι) και τον αριθμό των νικών του σε παιχνίδι πολλών παιχτών,
     * από προηγούμενα παιχνίδια. Το τρέχον σκορ (ατομικού παιχνιδιού) θεωρείται 0.
     ...
     * @throws ClassNotFoundException Σε περίπτωση που δεν μπορεί να βρεθεί κλάση Serialized αντικειμένου στο αρχείο.
     */
