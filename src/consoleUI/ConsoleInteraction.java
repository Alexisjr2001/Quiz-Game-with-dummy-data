...
public class ConsoleInteraction {
     ...
     * Υλοποιεί την λογική του κύριου μενού που χειρίζεται την επιλογή απο τον χρήστη μίας απο τις ενέργειες:
     ...
     * Χειρίζεται την επιλογή απο τον χρήστη μία απο τις ενέργειες:
     * Δημιουργία παίχτη, Διαγραφή παίχτη, Αλλαγή ονόματος παίχτη, Εμφάνιση πίνακα με σκόρ, Επιστροφή (μεταφορά πίσω) στο κύριο μενού.
     */
    private void playerManagement(){
        ...
        while(executionContinues){ // Η επανάληψη εκτελείται μέχρι ο χρήστης να επιλέξει την ενέργεια "Κύριο Μενού"
            ...
            Command userAnswer = parser.promptCommand("Επίλεξε μία απο τις παραπάνω ενέργειες για συνέχεια ή πάτησε \"Βοήθεια\" για λεπτομέρειες σχετικά με τις ενέργειες",
                    availableCommands); // Ζητάω επιλογή απο τις ενέργειες.
            String userResponce, userSecondResponce; // Μεταβλητές που αποθηκεύουν την πρώτη και (αν χρειστεί) την δεύτερη απάντηση του χρήστη
            switch (userAnswer){ // Εκτέλεση επιλεγμένης ενέργειας
     ...
     * Χειρίζεται την επιλογή απο τον χρήστη μίας απο τις ενέργειες:
