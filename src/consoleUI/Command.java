...
public enum Command {
    ...
    //,SCORE_PLAYER("Εμφάνιση σκορ παίχτη", "Εμφανίζεται το τρέχον ατομικό σκορ του παίχτη") // TODO: REMOVE IF NOT NEEDED
    ...
    public final String greekName; // Η αντίστοιχη ονομασία της εντολής (ενέργειας) στα ελληνικά
    public final String description; // Η (ελληνική) περιγραφή της εντολής
