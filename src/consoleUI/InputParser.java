...
public class InputParser {
    ...
    /**
     * Τυπώνει έναν χαρακτήρα '{@code >}' και δέχεται μία συμβολοσειρά απο τον χρήστη την οποία επιστρέφει.
     *
    ...
    /**
     * Ελέγχει αν μία συμβολοσειρά είναι μία απο τις αποδεκτές εντολές - ενέργειες χρήστη που καθορίζονται απο το δεύτερο όρισμα.
     *
     ...
     * Άν δώσει οποιαδήποτε άλλη συμβολοσειρά, αγνοείται, τυπώνεται μήνυμα λάθους και επαναλαμβάνεται η παραπάνω διαδικασία.
     *
     * Σε περίπτωση μη αποδεκτής εισόδου, τυπώνονται στον χρήστη τα μηνύματα: "Μη έγκυρη απάντηση..." και "Επέλεξε 1, 2, 3 ή 4.".
     *
     * Η είσοδος απο τον χρήστη γίνεται μέσω της μεθόδου prompt() της παρούσας κλάσης.
     *
     * @return αριθμός που έδωσε ο χρήστης (είναι ένας απο τους 1, 2, 3, 4).
     */
    public int promptAnswer(){
        boolean isIncomplete = true; // Η μεταβλητή που ελέγχει τον βρόχο
        String aPrompt;
