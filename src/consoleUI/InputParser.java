...
public class InputParser {
     ...
     *
     * Αναλυτικά, τυπώνει στον χρήστη ενα μήνυμα και προχωράει στην επόμενη γραμμή και αφού τυπώσει έναν χαρακτήρα '>' και ένα κενό δέχεται μία συμβολοσειρά απο τον χρήστη την οποία επιστρέφει.
     * Το σύμβολο '>' αναπαριστά γραφικά ότι ο χρήστης πρέπει να παρέχει δεδομένα.
     *
    ...
    /**
     * Τυπώνει έναν χαρακτήρα '>' δέχεται μία συμβολοσειρά απο τον χρήστη την οποία επιστρέφει.
     *
     * Τυπώνει τον χαρακτήρα '>' (και ένα κενό) για να παρασταθεί γραφικά ότι ο χρήστης πρέπει να παρέχει δεδομένα.
     *
     * @return την συμβολοσειρά που θα δώσει το χρήστης
     */
