...
/**
 * Η κλάση GameSequenceHandler αποτελεί την μονάδα που χειρίζεται το "λειτουργικό" μέρος του παιχνιδιού, όσον αφορά το γραφικό περιβάλλον.
...
public class GameSequenceHandler {
    ...
    private boolean[] playerHasAnswered; // Ο πίνακας που αποθηκεύει την κατάστασης απάντησης (αν έχει απαντήσει ή όχι) για τον κάθε παίχτη
     ...
     * Για να ξεκινήσει το παιχνίδι αρκεί να εκκινηθεί μια πρώτη ερώτηση και για να γίνει αυτό αρκεί να κληθεί μια φόρα η μέθοδος proceedToNextQuestion.
     *
     ...
     * αφού έχει υπολογίσει και θέσει τα αποτελέσματα του παιχνιδιού και έχει εκτελέσει τις απαραίτητες ενέργειες που
     * επιτρέπουν στην συνεδρία παιχνιδιού να τερματιστεί στην συνέχεια.
     *
     ...
     * Τέλος, περιέχει κουμπί που επιστρέφει στο μενού εκκίνησης παιχνιδιού.
     */
    public void gameFinishedMenu() {
        ...
        for (KeyListener kl : basePanel.getKeyListeners()){ // Αφαιρώ τους υπάρχοντες KeyListeners εφόσον έχει τελειώσει πια το παιχνίδι
