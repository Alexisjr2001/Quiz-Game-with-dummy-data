 ...
 * το μέγιστο σκορ ατομικού παιχνιδιού και τις νίκες παιχνιδιού πολλών παιχτών του κάθε παίχτη.
 *
...
public class ScoreboardDialog{
     ...
     * θα πρέπει να περιέχει τα ονόματα των παιχτών, η δεύτερη το τρέχον σκόρ του (ατομικού παιχνιδιού), η τρίτη το μέγιστο σκορ (highscore ατομικού παιχνιδιού) και
     * η τέταρτη τον αριθμό νικών σε παιχνίδι πολλών παιχτών.
     *
     * @param owner αναφορά στο Frame της εφαρμογής που προκάλεσε την εμφάνιση του παρόντος διαλόγου
