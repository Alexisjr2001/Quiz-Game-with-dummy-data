 ...
 *
 * Όσον αφορά τα δεδομένα της εφαρμογής: Οι ερωτήσεις διαβάζονται απο το αρχείο Ερωτήσεις.txt και τα στατιστικά δεδομένα
 * διαβάζονται/γράφονται απο/στο αρχείο Στατιστικά Παιχνιδιού.bin (και τα δύο αρχεία βρίσκονται σε επίπεδο project).
 *
...
public class GUI {
    ...
    private void initPlayerManagement(){
        ...
        tempButton = new JButton("Εμφάνιση Πίνακα Στατιστικών");
        tempButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent actionEvent) {
        ...
        tempButton.setToolTipText("Εμφανίζεται ο πίνακας με τα στατιστικά του παιχνιδιού");
        playerManagementPanel.add(StaticTools.wrapInFlowLayout(tempButton));
        ...
        tempButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                JOptionPane.showMessageDialog(mainWindow, String.format("Το παιχνίδι αποτελείται απο έναν αριθμό γύρων όπου κάθε ένας έχει έναν αριθμό ερωτήσεων.%n" +
                        ...
                        "%nΑνα πάσα στιγμή κατά την διάρκεια του παιχνιδιού μπορείς να γυρίσεις στο μενού εκκίνησης παιχνιδιού κάνοντας δεξί κλικ και στην συνέχεια πατώντας επιστροφή στο μενού εκκίνησης.%n" +
                        "Με την επιστροφή πριν τελειώσει κάποιος γύρος, προσμετράται η νίκη / ήττα (ή σκόρ σε ατομικό παιχνίδι) απο την αρχή μέχρι την ερώτηση του γύρου που μόλις διακόπηκε."),
